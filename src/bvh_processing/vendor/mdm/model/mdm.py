...
from bvh_processing.vendor.mdm.model.bert import load_bert
from bvh_processing.vendor.mdm.utils.misc import WeightedSum
...
class MDM(nn.Module):
    def __init__(self, modeltype, njoints, nfeats, num_actions, translation, pose_rep, glob, glob_rot,
        ...
        if self.cond_mode != 'no_cond':
            if 'text' in self.cond_mode:
                ...
                if self.text_encoder_type == "clip":
                    ...
                    print("Loading BERT...")
                    bert_model_path = kargs["text_encoder_path"]
        ...
        # HumanML3D inference uses 263D features directly. The original MDM
        # eagerly loaded SMPL here even though this path never converts to mesh.
        self.rot2xyz = None
